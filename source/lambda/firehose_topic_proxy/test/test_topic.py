...
def test_mappings_stream():
    ...
    response = firehose.put_record(
        ...
        Record = {
            'Data': json.dumps({"job_id": "1234567890123456789012345", "job_timestamp":"2020-06-26T19:05:16.785Z", "id_str":"1274349265528057858", "topic": "005"})+'\n'
        }
    )
...
def test_mappings_topics():
    ...
    topicsEvent = {
        ...
        "region": "us-west-2",
        "resources": [],
        "detail":  {"job_id": "1234567890123456789012345", "job_timestamp":"2020-06-26T19:05:16.785Z", "id_str":"1274349265528057858", "topic": "001"}
    }
