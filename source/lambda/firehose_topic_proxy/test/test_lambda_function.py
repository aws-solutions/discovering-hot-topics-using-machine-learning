        ...
        ExtendedS3DestinationConfiguration={
            ...
            "DataFormatConversionConfiguration": {
                ...
                "OutputFormatConfiguration": {
                    "Serializer": {"ParquetSerDe": {"Compression": "UNCOMPRESSED"}}
                },
                "SchemaConfiguration": {
...
def test_lambda_function_with_topic_event():
    ...
    topic_event = {
        ...
        "detail": {
            "000": [
                {
                    "job_id": "1234567890123456789012345", "job_timestamp":"2020-06-26T19:05:16.785Z",
                    "topic": "000",
                    "term": "health",
                    "weight": "0.09484477"                },
                {
    ...
    with patch.dict('os.environ', {'TOPICS_NS': 'com.analyze.topic.inference.topics', 'TOPIC_MAPPINGS_NS': 'com.analyze.inference.mappings'}):
...
def test_lambda_function_with_mapping_event():
    ...
    mapping_event = {
        ...
        "region": "us-west-2",
        "resources": [],
        "detail": {"job_id": "1234567890123456789012345", "job_timestamp":"2020-06-26T19:05:16.785Z", "id_str":"1274357316737957888", "topic": "000"}
    }

    with patch.dict('os.environ', {'TOPICS_NS': 'com.analyze.inference.topics', 'TOPIC_MAPPINGS_NS': 'com.analyze.topic.inference.mappings'}):
