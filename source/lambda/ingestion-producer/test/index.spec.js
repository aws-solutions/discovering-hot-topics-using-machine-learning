...
describe('when producer lambda is invoked', () => {
    ...
    beforeEach(() => {
        ...
        checkLimitStub = sinon.stub(TwitterClient.prototype, 'hasLimit').returns(400);
...
describe('check loop execution based on throttling', () => {
    ...
    beforeEach(() => {
        ...
        checkLimitStub = sinon.stub(TwitterClient.prototype, 'hasLimit').returns(2);
...
describe('No remaining limit', () => {
    ...
    beforeEach(() => {
        ...
        checkLimitStub = sinon.stub(TwitterClient.prototype, 'hasLimit').returns(0);
...
describe('Failures are logged by lambda and thrown', () => {
    ...
    it('should not call the twitter search endpoint', async () => {
        ...
        checkLimitStub = sinon.stub(TwitterClient.prototype, 'hasLimit').returns(10);
