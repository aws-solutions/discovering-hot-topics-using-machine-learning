        ...
        const response = await feedTracker.updateTracker(
            {
                ...
                'next_results':
                    '?max_id=12345678901234567890&q=from%3Atwitterdev&count=2&include_entities=1&result_type=mixed',
                'query': 'from%3Atwitterdev',
                'refresh_url':
                    '?since_id=12345678901234567890&q=from%3Atwitterdev&result_type=mixed&include_entities=1',
                'count': 2,
                'since_id': 0,
                'since_id_str': '0'
            },
