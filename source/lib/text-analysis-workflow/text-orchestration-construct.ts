...
export class TextOrchestration extends cdk.Construct {
    ...
    constructor (scope: cdk.Construct, id: string, props: TextOrchestrationProps) {
        ...
        imageBucketLambda.s3Bucket!.addToResourcePolicy(new iam.PolicyStatement({
        ...
        (this._stateMachine.role.node.tryFindChild('DefaultPolicy')?.node.findChild('Resource') as iam.CfnPolicy).addMetadata("cfn_nag",{
            rules_to_suppress: [{
                id: 'W76',
